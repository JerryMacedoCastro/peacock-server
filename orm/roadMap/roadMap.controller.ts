...
export class RoadMapController extends Repository<RoadMap> implements IController {
    public path = '/roadMap';
    ...
    private getAllRoadMaps = async (
        ...
        const roadMap = await this.roadMap.find({
            relations: ["teachingPlatform", "teachingStage", "teachingStrategy", "tools", "teacher"],
        });
    ...
    private postRoadMap = async (
        ...
        roadMap.teachingPlatform = await repTeachingPlatform.save(roadMap.teachingPlatform);
        roadMap.teachingStage = await repTeachingStage.save(roadMap.teachingStage);
        roadMap.teachingStrategy = await repTeachingStrategy.save(roadMap.teachingStrategy);
    ...
    findByIdTeacher(id: bigint) {
        return this.roadMap.createQueryBuilder("roadMap")
